...
//        }
        ...
        for (FirstPageBlog pageBlog : firstPageBlog) {
            Like like = likeDao.selectLikeByBlogId(pageBlog.getId());
            if (like == null) {
                pageBlog.setLikeCount(0);
            } else {
                pageBlog.setLikeCount(like.getLikeCount());
            }
